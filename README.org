...
#+CAPTION: Integration test status (macOS)
#+NAME:   fig:INT-TESTS
[[https://github.com/d12frosted/dotbot-brew/actions/workflows/macos.yml/badge.svg]]

#+CAPTION: Integration test status (Ubuntu)
#+NAME:   fig:INT-TESTS
[[https://github.com/d12frosted/dotbot-brew/actions/workflows/ubuntu.yml/badge.svg]]
